...
[ADP Leave Balance].[Annual Leave Balance],
[ADP Leave Balance].[Sick Leave Balance],
[ADP Leave Balance].[Long Service Leave Balance],
[Normal Hours Paid],
[Termination Date],
[Unknown Leave],
[Unplanned - Unpaid],
...
SUM([Unplanned - Unpaid]) as [Unplanned - Unpaid],
SUM([Unplanned - Paid]) as [Unplanned - Paid],
SUM([Planned - Unpaid]) as [Planned - Unpaid],
SUM([Planned - Paid]) as [Planned - Paid],
SUM([Unknown Leave]) as [Unknown Leave]
from 
...
on [ADP Leave Balance].[Report Date] = [ADP Sick Leave].[Report Date] 
and [ADP Leave Balance].[Code] =  [ADP Sick Leave].[Emp Code] 
